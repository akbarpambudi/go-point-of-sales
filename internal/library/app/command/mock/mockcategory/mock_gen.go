...
// Source: ./../../domain/category/repository.go
...
import (
	context "context"
	category "github.com/akbarpambudi/go-point-of-sales/internal/library/domain/category"
...
func (m *MockRepository) Create(ctx context.Context, entity *category.Category) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(ctx context.Context, id string, entity *category.Category) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Load(ctx context.Context, id string) (*category.Category, error) {
	m.ctrl.T.Helper()
